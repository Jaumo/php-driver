...
static HashTable *
php_driver_set_gc(CASS_COMPAT_OBJECT_HANDLER_TYPE *object, zval **table, int *n)
{
  *table = NULL;
  *n = 0;
...
void php_driver_define_Set()
{
  ...
  CASS_COMPAT_SET_COMPARE_HANDLER(php_driver_set_handlers.std, php_driver_set_compare);
