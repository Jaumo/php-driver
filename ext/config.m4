...
if test "$PHP_CASSANDRA" != "no"; then
  ...
  case $(uname -s) in
    Linux)
      CASSANDRA_CFLAGS="-Wall -Wextra -Werror -Wno-long-long -Wno-deprecated-declarations -Wno-unused-parameter -Wno-unused-result -Wno-variadic-macros -Wno-format -pthread"
      ;;
    Darwin)
